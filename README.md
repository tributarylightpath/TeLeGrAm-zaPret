...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com//"></a><a href="https://github.com//TeLeGrAm-zaPret">/TeLeGrAm-zaPret</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
Скачать TeLeGrAm-zaPret — запрет Discord (голос / RTC), обход DPI без VPN. Актуальная сборка в [Releases](./releases/latest) → 1.9.9c
</div>
...
> Если вы наткнулись на что-то вне репозитория `/TeLeGrAm-zaPret`, что распространяется от моего лица - **ФЕЙК**.
...
Если этого не произошло, то см. [#522](https://github.com//TeLeGrAm-zaPret/issues/522)
...
- См. [#765](https://github.com//TeLeGrAm-zaPret/issues/765)
...
- См. также [#251](https://github.com//TeLeGrAm-zaPret/discussions/251)
...
- См. также [#252](https://github.com//TeLeGrAm-zaPret/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com//TeLeGrAm-zaPret/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com//TeLeGrAm-zaPret/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com//TeLeGrAm-zaPret/blob/main/LICENSE.txt)
